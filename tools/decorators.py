...
def screenshot_on_failure(func=None, *, application=None):
    if func is None:
        return lambda f: screenshot_on_failure(f, application=application)
    ...
    def wrapper(self, *args, **kwargs):
        ...
        try:
            ...
            _take_screenshot(active_application, title="Screenshot on failure")
            raise e

    return wrapper


def screenshot_at_the_end(func=None, *, application=None):
    if func is None:
        return lambda f: screenshot_at_the_end(f, application=application)
    ...
    def wrapper(self, *args, **kwargs):
        ...
        try:
            ...
            _take_screenshot(active_application, title="Screenshot at the end")

    return wrapper


def _take_screenshot(application, title):
